...
# in windows there might be path issue, for safest way below 2 lines on code
os.environ["SSL_CERT_FILE"] = certifi.where()
os.environ["REQUESTS_CA_BUNDLE"] = certifi.where()

AVIATIONSTACK_API_KEY = os.getenv("AVIATIONSTACK_API_KEY")

# Change this if your default location is not Mangalore.
DEFAULT_ORIGIN_IATA = os.getenv("DEFAULT_ORIGIN_IATA", "IXE")
...
if __name__ == "__main__":
    print(search_flights("Plan a 7 days to Mumbai"))
    print("\n" + "=" * 80 + "\n")
